...
const Header: React.FC = () => {
  ...
  const navItems = [
    { path: '/', label: '홈', icon: '🏠' },
    { path: '/coffee-chats', label: '커피챗 목록', icon: '☕' },
    { path: '/create', label: '커피챗 만들기', icon: '✨' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            <div className="flex items-center justify-center w-10 h-10 bg-gradient-to-br from-primary-500 to-accent-500 rounded-xl shadow-lg group-hover:shadow-xl transition-all duration-300 transform group-hover:scale-105">
