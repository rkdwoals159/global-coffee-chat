  ...
  const features = [
    {
      icon: '🌍',
      title: '글로벌 네트워킹',
      description: '전 세계 다양한 국가에서 일하는 사람들과 연결되어 현지 정보를 얻을 수 있습니다.',
      color: 'from-blue-500 to-cyan-500'
    },
    {
      icon: '💼',
      title: '실무 경험 공유',
      description: '실제 해외 취업에 성공한 사람들의 생생한 경험과 노하우를 들을 수 있습니다.',
      color: 'from-green-500 to-emerald-500'
    },
    {
      icon: '🏠',
      title: '라이프스타일 정보',
      description: '취업뿐만 아니라 현지 생활, 문화, 비자 등 실용적인 정보도 얻을 수 있습니다.',
      color: 'from-purple-500 to-pink-500'
    },
    {
      icon: '🤝',
      title: '커뮤니티 형성',
      description: '같은 꿈을 가진 사람들과 함께 성장할 수 있는 커뮤니티를 형성합니다.',
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
          <div className="text-center">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-primary-500 to-accent-500 rounded-full shadow-2xl mb-8 animate-bounce-gentle">
              <span className="text-4xl">✈️</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
              <span className="text-gradient">트립챗</span>에서
              <br />
              <span className="text-primary-600">해외 취업의 꿈</span>을 현실로
            </h1>
